      ...
      <Container className="relative z-[2]">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-[16px] leading-relaxed text-white/70">
            Processing, a lender marketplace, seven agents and merchant-direct settlement — one API,
            one contract, one ledger. Book a walkthrough and watch a live lead flow through it.
          </p>
