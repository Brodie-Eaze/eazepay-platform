    ...
    <>
      ...
      <PageBody>
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
          <Card>
            <CardHeader title="Business" action={<Button size="sm" variant="ghost">Edit</Button>} />
            <CardBody>
              ...
              <DataRow label="MCC / industry" value={`${merchantOrg.mcc} · ${merchantOrg.industry}`} />
              <DataRow label="EazePay brand" value={<StatusPill tone="accent">TradePay</StatusPill>} />
              <DataRow label="KYB" value={<StatusPill tone="success">Verified · 2025-08-12</StatusPill>} />
            </CardBody>
          </Card>
          ...
          <Card>
            ...
            <CardBody>
              <DataRow label="Settlement account" value={<span className="font-mono text-[12px]">Chase ••••2104</span>} />
              <DataRow label="Routing" value={<span className="font-mono text-[12px]">021••••89</span>} />
              <DataRow label="Verification" value={<StatusPill tone="success">PennyDrop + Plaid</StatusPill>} />
          ...
          <Card>
            <CardHeader
              title={
                <span className="flex items-center gap-3">
                  MiCamp
                  <StatusPill tone="success" dot>Card processor · live</StatusPill>
                </span>
              }
            ...
            <CardBody>
              ...
              <DataRow label="3DS / risk-based step-up" value={<StatusPill tone="success">Enabled</StatusPill>} />
              ...
              <div className="mt-3 flex items-center gap-2 flex-wrap">
                ...
                <Button size="sm" variant="ghost" trailingIcon={<ArrowRightIcon size={14} />}>Open MiCamp dashboard</Button>
              </div>
            </CardBody>
          </Card>
          ...
          <Card>
            <CardHeader
              title={
                <span className="flex items-center gap-3">
                  HighSale
                  <StatusPill tone="success" dot>EZ Check · live</StatusPill>
                </span>
              }
            ...
            <CardBody>
              ...
              <DataRow label="Per-debit cap" value={<Money cents={250_000_00} compact noFractions />} />
              ...
              <div className="mt-3 flex items-center gap-2 flex-wrap">
                <Button size="sm" variant="secondary" leadingIcon={<WebhookIcon size={14} />}>Webhooks</Button>
                <Button size="sm" variant="ghost" trailingIcon={<ArrowRightIcon size={14} />}>Open HighSale dashboard</Button>
              </div>
            </CardBody>
          </Card>
          ...
          <Card>
            <CardHeader title="Branding" description="Applied to your hosted application links and emails." />
            <CardBody>
              ...
              <DataRow label="Brand color" value={<span className="flex items-center gap-2"><span className="size-4 rounded" style={{ background: '#0066CC' }} /> #0066CC</span>} />
