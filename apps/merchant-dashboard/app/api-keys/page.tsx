...
const keys: Key[] = [
  {
    id: 'k_live_1',
    name: 'Production',
    prefix: 'pk_live_8KvR2NQp…',
    env: 'live',
    createdAt: '2025-08-12',
    lastUsed: '2026-05-04T18:55Z',
  },
  {
    id: 'k_test_1',
    name: 'Sandbox',
    prefix: 'pk_test_R2NQpLm…',
    env: 'test',
    createdAt: '2025-08-12',
    lastUsed: '2026-05-03T11:22Z',
  },
];
...
const columns: Column<Key>[] = [
  ...
  },
  {
    key: 'created',
    header: 'Created',
    cell: (k) => <span className="text-[12px] tabular-nums">{k.createdAt}</span>,
  },
  {
    key: 'used',
    header: 'Last used',
    ...
    cell: (k) => (
      <span className="text-[12px] text-fg-muted tabular-nums">
        {k.lastUsed ? new Date(k.lastUsed).toLocaleString('en-US') : 'never'}
      </span>
    ),
  },
  {
    ...
    <>
      ...
      <PageBody>
        <Banner intent="warning" className="mb-4" title="Keep secret keys server-side">
          Publishable keys (<code>pk_*</code>) are safe in client code. Secret keys (
          <code>sk_*</code>) must never appear in browsers, mobile apps, or version control.
        </Banner>
