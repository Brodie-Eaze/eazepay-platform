...
/**
 * Public list of participating lenders surfaced on the consumer-facing
 * disclosure card. Pure constant — safe in the browser bundle. Kept in
 * lockstep with the server-side store; sourced from the same legal
 * partnership matrix the BFF reads.
 */
