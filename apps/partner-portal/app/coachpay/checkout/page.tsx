/**
 * CoachPay · Checkout (/coachpay/checkout)
 *
 * Aurean-style conversion page. The prospect lands here from
 * /coachpay/start, the sales deck final CTA, or the /landing/coachpay
      ...
      <header className="mpf-nav">
        <div className="mpf-container mpf-nav-inner">
          ...
          <nav className="mpf-nav-links" aria-label="Primary">
            ...
            <Link href="/landing/coachpay">Long story</Link>
          </nav>
        ...
        <section className="mpf-hero">
          <div className="mpf-container">
            <div className="mpf-eyebrow-pill">
              ...
              Activate CoachPay · Step 1 of 2
            </div>
            <h1 className="mpf-h1">
              <span className="mpf-grad-teal">Activate CoachPay</span>
              <br />
              <span className="mpf-grad-teal-deep">for your coaching business.</span>
            </h1>
          ...
          <div className="mpf-container">
            <div className="mpf-pricing-grid">
              ...
              <PricingTier
                ...
                body="At the end of each month we invoice 4% of loans that actually settled. No funded loan → no origination fee. Tracked per-lender, per-coach."
                v="4%"
            ...
            <div className="mpf-co-wrap">
              <div className="mpf-co-l">
                ...
                <ul className="mpf-co-points">
                  <li>
                    ...
                    originator. Lenders carry the credit risk; the coaching business does not.
                  </li>
                  <li>
                    <span className="mpf-co-check" aria-hidden>
                      ✓
                  ...
                  <li>
                    ...
                    any time. Existing loans funded under CoachPay continue under their lender
                    terms.
                  </li>
                  <li>
                    <span className="mpf-co-check" aria-hidden>
              ...
              <form className="mpf-co-form" onSubmit={(e) => e.preventDefault()}>
                ...
                <label className="mpf-co-field">
                  ...
                  <input
                    type="email"
                    placeholder="ops@beckexecutive.com"
                    value={billingEmail}
...
.mpf-tier {
  ...
  box-shadow: 0 18px 50px -28px rgba(139, 92, 246, 0.22);
}
.mpf-tier.is-hero {
  background:
...
.mpf-tier.is-hero .mpf-tier-when { color: rgba(20, 16, 40, 0.40); }
.mpf-pricing-foot {
...
.mpf-co-form {
  padding: 24px;
  background:
    radial-gradient(ellipse 80% 100% at 100% 0%, rgba(167, 139, 250, 0.12), transparent 70%),
    rgba(20, 16, 40, 0.55);
  border: 1px solid var(--mp-line-strong);
  border-radius: 18px;
  display: flex; flex-direction: column; gap: 14px;
  box-shadow: 0 28px 60px -28px rgba(139, 92, 246, 0.32);
}
