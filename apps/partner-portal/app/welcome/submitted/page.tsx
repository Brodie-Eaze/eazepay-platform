    ...
    <main className="min-h-screen bg-bg">
      ...
      <div className="max-w-xl mx-auto px-6 py-16 text-center">
        ...
        <p className="mt-3 text-[14px] text-fg-secondary leading-relaxed">
          ...
          email within one business day either confirming approval or asking for one more piece
          of info.
        </p>

        <ol className="mt-8 text-left space-y-3 rounded-xl border border-border bg-bg-elevated p-5">
          {[
            { t: 'KYB verification', d: 'IRS EIN match, Secretary-of-State good standing, OFAC + PEP screen.' },
            { t: 'Owner identity check', d: 'Each beneficial owner gets a secure link to verify their ID.' },
            { t: 'Merchant agreement', d: 'A countersigned PDF lands in your inbox once owners verify.' },
            { t: 'You go live', d: 'Bank account verified via Plaid Auth, processor MID provisioned, branded checkout enabled.' },
          ].map((step, i) => (
