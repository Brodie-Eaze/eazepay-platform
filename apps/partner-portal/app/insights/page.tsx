...
const vintageMatrix: (number | null)[][] = [
  ...
  [0.001, 0.010, 0.017, 0.021, 0.025, 0.029],
  [0.001, 0.012, 0.019, 0.023, 0.027, 0.030],
  [0.001, 0.013, 0.020, 0.024, 0.028, null],
...
const aprBuckets = (() => {
  ...
  const peaks = [3, 9, 18, 34, 62, 95, 128, 154, 168, 162, 144, 121, 104, 88, 72, 58, 46, 35, 27, 21, 16, 12, 9, 6, 4];
  const start = 4.99;
...
/* APR by lender × tier */
const lenderTierApr: { lender: string; primeBps: number | null; nearPrimeBps: number | null; subPrimeBps: number | null; deepSubBps: number | null }[] = [
  { lender: 'Helia Medical',   primeBps: 999,  nearPrimeBps: 1399, subPrimeBps: null,  deepSubBps: null },
  { lender: 'SageHeal',        primeBps: 1199, nearPrimeBps: 1599, subPrimeBps: 2099,  deepSubBps: null },
  { lender: 'Orion Capital',   primeBps: 849,  nearPrimeBps: 1199, subPrimeBps: null,  deepSubBps: null },
  { lender: 'Kestrel',         primeBps: 1099, nearPrimeBps: 1499, subPrimeBps: 1899,  deepSubBps: null },
  { lender: 'Atlas Career Cap',primeBps: 799,  nearPrimeBps: null, subPrimeBps: null,  deepSubBps: null },
  { lender: 'ClearPath',       primeBps: 1299, nearPrimeBps: 1799, subPrimeBps: 2299,  deepSubBps: 2799 },
  { lender: 'Summit Premier',  primeBps: 749,  nearPrimeBps: null, subPrimeBps: null,  deepSubBps: null },
  { lender: 'BuzzPay',         primeBps: 1099, nearPrimeBps: 1399, subPrimeBps: 1899,  deepSubBps: null },
  { lender: 'Evergreen Prime', primeBps: 899,  nearPrimeBps: 1299, subPrimeBps: null,  deepSubBps: null },
  { lender: 'Sterling Direct', primeBps: 1199, nearPrimeBps: 1599, subPrimeBps: 1999,  deepSubBps: 2499 },
];
...
const stateCoverage: StateRow[] = [
  ...
  { code: 'NY', name: 'New York',     fundedCents: 612_840_00,  fundedCount: 168, status: 'restricted', note: 'Rate cap 16% APR — sub-set of lenders' },
...
const disparateImpact: { dim: string; ageGroup: boolean; sex: boolean; raceProxy: boolean; geography: boolean }[] = [
  ...
  { dim: 'Adverse-action consistency', ageGroup: true, sex: true, raceProxy: true, geography: true },
];
...
/* Sample overrides */
const overrideSamples: { id: string; brand: string; ficoBand: string; direction: 'up' | 'down'; rationale: string; reviewedAt: string }[] = [
  { id: 'ovr_2026_05_04_A8K', brand: 'MedPay',  ficoBand: '640-659', direction: 'up',   rationale: 'Cashflow stability 88; income verified 2yr; manual approval inside policy.', reviewedAt: '2026-05-07' },
  { id: 'ovr_2026_05_02_R2N', brand: 'TradePay', ficoBand: '700-739', direction: 'down', rationale: 'Recent BK chapter 13 not surfaced by bureau pull — manual decline.',          reviewedAt: '2026-05-05' },
  { id: 'ovr_2026_05_01_KvL', brand: 'CoachPay', ficoBand: '660-699', direction: 'up',   rationale: 'Co-borrower added post-decision; combined DTI 31%.',                          reviewedAt: '2026-05-04' },
];
...
const recentDecisions: DecisionRow[] = [
  { appId: '4nqLkR2vTjW', initials: 'J.M.', brand: 'TradePay', fico: 762, requestedCents: 1_850_000, decision: 'approved',     reason: 'within_policy',        lender: 'Evergreen Prime', ttdMs: 612 },
  { appId: '8mRT2WQpKvN', initials: 'D.K.', brand: 'MedPay',   fico: 718, requestedCents: 720_000,   decision: 'approved',     reason: 'within_policy',        lender: 'Helia Medical',   ttdMs: 488 },
  { appId: '9xQpL4mNkjT', initials: 'A.R.', brand: 'CoachPay', fico: 642, requestedCents: 1_200_000, decision: 'declined',     reason: 'debt_to_income_high',  lender: '—',               ttdMs: 734 },
  { appId: '2KvNRpL8mqT', initials: 'S.P.', brand: 'TradePay', fico: 798, requestedCents: 2_500_000, decision: 'approved',     reason: 'within_policy',        lender: 'Summit Premier',  ttdMs: 421 },
  { appId: '5NQpRT8mvK2', initials: 'L.W.', brand: 'TradePay', fico: 681, requestedCents: 980_000,   decision: 'manual_review',reason: 'income_verification',  lender: 'queued',          ttdMs: 0   },
  { appId: '7tpQR2NvKmL', initials: 'R.B.', brand: 'MedPay',   fico: 731, requestedCents: 450_000,   decision: 'approved',     reason: 'within_policy',        lender: 'BuzzPay',         ttdMs: 552 },
  { appId: 'KvNRT8mQp2L', initials: 'M.T.', brand: 'MedPay',   fico: 598, requestedCents: 1_500_000, decision: 'declined',     reason: 'min_fico_floor',       lender: '—',               ttdMs:  87 },
  { appId: 'RT8mQp2KvNL', initials: 'E.H.', brand: 'TradePay', fico: 802, requestedCents: 3_200_000, decision: 'approved',     reason: 'within_policy',        lender: 'Summit Premier',  ttdMs: 503 },
  { appId: 'p2KvNRT8mQL', initials: 'T.C.', brand: 'CoachPay', fico: 704, requestedCents: 320_000,   decision: 'approved',     reason: 'within_policy',        lender: 'Atlas Career Cap',ttdMs: 461 },
  { appId: 'pLKvNRT8mQT', initials: 'B.D.', brand: 'CoachPay', fico: 656, requestedCents: 580_000,   decision: 'declined',     reason: 'insufficient_stability',lender:'—',               ttdMs: 612 },
  { appId: 'mQp2KvNRT8L', initials: 'I.O.', brand: 'MedPay',   fico: 689, requestedCents: 920_000,   decision: 'approved',     reason: 'within_policy',        lender: 'Helia Medical',   ttdMs: 541 },
  { appId: 'NRT8mQp2KvL', initials: 'N.F.', brand: 'TradePay', fico: 633, requestedCents: 1_100_000, decision: 'declined',     reason: 'recent_delinquency_60d',lender:'—',              ttdMs: 588 },
  { appId: 'T8mQp2KvNRL', initials: 'C.M.', brand: 'TradePay', fico: 742, requestedCents: 1_980_000, decision: 'approved',     reason: 'within_policy',        lender: 'Orion Capital',   ttdMs: 491 },
  { appId: 'QpL8mRT2NvK', initials: 'G.A.', brand: 'CoachPay', fico: 712, requestedCents: 480_000,   decision: 'approved',     reason: 'within_policy',        lender: 'Atlas Career Cap',ttdMs: 522 },
  { appId: 'L8mRT2NvKqp', initials: 'K.S.', brand: 'MedPay',   fico: 671, requestedCents: 640_000,   decision: 'approved',     reason: 'within_policy',        lender: 'SageHeal',        ttdMs: 681 },
  { appId: '2NvKqpL8mRT', initials: 'P.R.', brand: 'TradePay', fico: 588, requestedCents: 720_000,   decision: 'declined',     reason: 'min_fico_floor',       lender: '—',               ttdMs:  92 },
  { appId: 'vKqpL8mRT2N', initials: 'O.G.', brand: 'MedPay',   fico: 754, requestedCents: 1_150_000, decision: 'approved',     reason: 'within_policy',        lender: 'Helia Medical',   ttdMs: 478 },
  { appId: 'pL8mRT2NvKq', initials: 'F.E.', brand: 'TradePay', fico: 695, requestedCents: 1_350_000, decision: 'manual_review',reason: 'collateral_review',    lender: 'queued',          ttdMs: 0   },
  { appId: 'mRT2NvKqpL8', initials: 'H.W.', brand: 'CoachPay', fico: 681, requestedCents: 280_000,   decision: 'approved',     reason: 'within_policy',        lender: 'ClearPath',       ttdMs: 612 },
  { appId: 'RT2NvKqpL8m', initials: 'V.N.', brand: 'MedPay',   fico: 728, requestedCents: 880_000,   decision: 'approved',     reason: 'within_policy',        lender: 'BuzzPay',         ttdMs: 412 },
];
...
const seriesFunded = [38, 41, 39, 42, 38, 36, 41, 44, 47, 49, 51, 47, 49, 52, 48, 51, 54, 56, 54, 57, 59, 61, 58, 60, 62, 64, 63, 65, 66, 67];
const seriesDollars = [310, 332, 308, 351, 322, 298, 341, 367, 388, 412, 421, 388, 401, 432, 408, 429, 451, 472, 461, 488, 502, 521, 498, 514, 528, 542, 537, 552, 561, 572];
const seriesPullthrough = [40, 41, 39, 42, 41, 42, 43, 42, 44, 45, 44, 43, 45, 46, 44, 45, 46, 47, 46, 46, 47, 48, 47, 47, 48, 48, 48, 47, 48, 47.8];
const seriesAvgSize = [11.8, 12.1, 11.9, 12.4, 12.0, 12.3, 12.5, 12.7, 12.6, 12.8, 13.0, 12.9, 13.1, 13.2, 13.0, 13.1, 13.3, 13.4, 13.3, 13.5, 13.6, 13.7, 13.5, 13.6, 13.7, 13.8, 13.7, 13.8, 13.9, 13.86];
const seriesLift = [4.1, 4.2, 4.0, 4.3, 4.2, 4.1, 4.4, 4.5, 4.6, 4.7, 4.8, 4.6, 4.7, 4.9, 4.8, 4.8, 5.0, 5.1, 5.0, 5.1, 5.2, 5.3, 5.2, 5.2, 5.3, 5.4, 5.3, 5.4, 5.5, 5.42];
const seriesManualReview = [9.8, 9.6, 9.5, 9.4, 9.2, 9.0, 8.9, 8.8, 8.7, 8.6, 8.5, 8.5, 8.4, 8.4, 8.3, 8.3, 8.2, 8.2, 8.1, 8.1, 8.0, 8.0, 7.9, 7.9, 7.8, 7.8, 7.8, 7.7, 7.7, 7.6];
...
function LabeledBarChart({
  ...
  return (
    <svg width="100%" height={height} viewBox={`0 0 ${width} ${height}`} preserveAspectRatio="none" className="text-accent">
      {/* grid lines */}
...
function HistogramChart({
  ...
  return (
    <svg width="100%" height={height} viewBox={`0 0 ${width} ${height}`} preserveAspectRatio="none" className="text-chart-2">
      {[0.25, 0.5, 0.75, 1].map((t) => (
        <line key={t} x1={padX} x2={width - padX} y1={padTop + chartH * (1 - t)} y2={padTop + chartH * (1 - t)} stroke="currentColor" opacity={0.08} strokeDasharray="2 4" />
      ))}
      {buckets.map((b, i) => {
        const h = Math.max(1.5, (b.count / max) * chartH);
        const x = padX + i * (barW + 1.5);
        const y = padTop + chartH - h;
        return <rect key={i} x={x} y={y} width={barW} height={h} rx={1.5} fill="currentColor" opacity={0.78} />;
      })}
      ...
      {[
        ...
        <g key={m.label}>
          <line x1={aprToX(m.v)} x2={aprToX(m.v)} y1={padTop - 4} y2={padTop + chartH} stroke="currentColor" strokeWidth={1.25} strokeDasharray={m.dash} opacity={0.9} />
          <text x={aprToX(m.v) + 4} y={padTop + 8} fontSize="9.5" fill="currentColor" opacity={0.95} className="font-medium">{m.label}</text>
        </g>
      ))}
      {/* x-axis labels */}
      {[0, 0.25, 0.5, 0.75, 1].map((t) => {
        ...
        return (
          <text key={t} x={padX + chartW * t} y={height - 6} textAnchor="middle" fontSize="9" fill="currentColor" opacity={0.6}>
            {apr.toFixed(2)}%
          </text>
        );
      })}
  ...
  return (
    <div className="grid gap-1.5">
      {steps.map((s, i) => {
        ...
        return (
          <div key={s.label} className="grid grid-cols-[180px_1fr_64px_64px_72px] gap-3 items-center text-[12px]">
            ...
            <div className="text-right tabular-nums text-fg-secondary font-medium">{fmtPct(conversionFromTop, 1)}</div>
            <div className={`text-right tabular-nums ${dropPct != null && dropPct > 0.15 ? 'text-warning' : 'text-fg-muted'}`}>
...
function HeatCell({ value, label, intensity = 'accent' }: { value: number | null; label?: string; intensity?: 'accent' | 'danger' | 'warning' }) {
  if (value == null) {
    return (
  ...
  const color = intensity === 'danger' ? 'rgb(var(--danger))' : intensity === 'warning' ? 'rgb(var(--warning))' : 'rgb(var(--chart-2))';
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 rounded-sm" style={{ background: color, opacity }} aria-hidden />
    </div>
  );
}
  ...
  return (
    <>
      <PageHeader
        ...
        meta={
          <>
            <StatusPill tone="success" dot>Bias review — within tolerance</StatusPill>
      ...
      <PageBody>
        <Banner intent="info" className="mb-5">
          ...
          decisioned cohort weekly. Quarterly written review is exported to your bank-partner audit pack.
          All decisions reproducible from input snapshot + policy version orch_v_2026_05_a.
        </Banner>
        ...
        <Card className="mb-4">
          ...
          <CardBody>
            ...
            <div className="mt-3 text-[11.5px] text-fg-muted leading-relaxed">
              ...
              the FICO floor + DTI threshold enforced by the orchestrator. Pre-qual to KYC stays in tight
              tolerance (5.6% drop). Funded conversion from approval = 91.6%.
            </div>
          </CardBody>
        </Card>
          ...
          <CardHeader
            ...
            action={
              <div className="flex items-center gap-2">
                <StatusPill tone="neutral">Sources: {marketplaceLenders.length} lender configs · {marketplaces.length} marketplaces</StatusPill>
              </div>
            }
          />
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-[12.5px]">
                <thead className="bg-bg-muted/40 border-b border-border">
                  <tr>
                    <th className="px-4 py-2 text-left text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Lender</th>
                    <th className="px-4 py-2 text-left text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Marketplace</th>
                    <th className="px-4 py-2 text-right text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Apps routed</th>
                    <th className="px-4 py-2 text-right text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Approval</th>
                    <th className="px-4 py-2 text-right text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Avg APR</th>
                    <th className="px-4 py-2 text-right text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Stip rate</th>
                    <th className="px-4 py-2 text-right text-[10px] uppercase tracking-wider text-fg-muted font-semibold">SLA p95</th>
                    <th className="px-4 py-2 text-center text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Status</th>
                  </tr>
                </thead>
                <tbody>
                  {lenderWinRows.map((r) => {
                    const tone: StatusTone = r.status === 'active' ? 'success' : r.status === 'degraded' ? 'warning' : 'neutral';
                    return (
                      <tr key={r.id} className="border-b border-border last:border-b-0 hover:bg-bg-muted/40">
                        <td className="px-4 py-2 font-medium">{r.lender}</td>
                        <td className="px-4 py-2 text-fg-muted">{r.marketplace}</td>
                        <td className="px-4 py-2 text-right tabular-nums">{r.routed.toLocaleString()}</td>
                        <td className="px-4 py-2 text-right tabular-nums font-medium">{fmtPct(r.approvalRate, 1)}</td>
                        <td className="px-4 py-2 text-right tabular-nums">{fmtBps(r.avgAprBps)}</td>
                        <td className="px-4 py-2 text-right tabular-nums">{fmtPct(r.stipRate, 1)}</td>
                        <td className="px-4 py-2 text-right tabular-nums">{fmtMs(r.slaP95Ms)}</td>
                        <td className="px-4 py-2 text-center">
                          <StatusPill tone={tone} dot>{r.status}</StatusPill>
                        </td>
                      </tr>
                    );
                  })}
          ...
          <Card>
            ...
            <CardBody>
              ...
              <div className="mt-3 text-[12px] text-fg-muted leading-relaxed">
                ...
                additions. We continue to enforce ECOA non-discrimination notice + reason codes on every decline.
              </div>
            </CardBody>
          </Card>
          ...
          <Card>
            ...
            <CardBody>
              <div className="text-chart-4">
                <LabeledBarChart data={declineReasonDistribution} height={170} formatValue={(v) => `${v}%`} />
              </div>
              <div className="mt-3 text-[12px] text-fg-muted leading-relaxed">
                Reason taxonomy is mapped to the Reg B § 1002 examples and reviewed quarterly with compliance.
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 mb-4">
          <Card>
            ...
            <CardBody>
              <div className="grid grid-cols-[120px_repeat(3,1fr)] gap-1.5">
                <div />
                <div className="text-center text-[11px] text-fg-muted font-semibold uppercase tracking-wider">MedPay</div>
                <div className="text-center text-[11px] text-fg-muted font-semibold uppercase tracking-wider">TradePay</div>
                <div className="text-center text-[11px] text-fg-muted font-semibold uppercase tracking-wider">CoachPay</div>
                {conversionRows.map((row) => (
                  <>
                    <div key={`${row.label}-l`} className="text-[12px] text-fg-secondary font-medium self-center">{row.label}</div>
              ...
              <div className="mt-3 text-[11.5px] text-fg-muted leading-relaxed">
                MedPay leads on accept-rate (68%) — patient demand is sticky. TradePay
                shows lower approved-to-accepted, consistent with larger ticket sizes and merchant-side stips.
              </div>
            </CardBody>
          </Card>
          ...
          <Card>
            <CardHeader
              ...
              action={<StatusPill tone="warning" dot>Anomaly: 2026-03 +80bps</StatusPill>}
            />
            <CardBody>
              <div className="grid grid-cols-[80px_repeat(6,1fr)] gap-1 text-[10px]">
                <div />
                {vintageWindowLabels.map((w) => (
                  <div key={w} className="text-center text-fg-muted font-semibold uppercase tracking-wider">{w}</div>
                ))}
                {vintageMonths.map((m, i) => {
                  const row = vintageMatrix[i] ?? [];
                  return (
                    <>
                      <div key={`${m}-lbl`} className="text-fg-secondary font-medium self-center text-[10.5px]">{m}</div>
                      {row.map((v, j) => (
              ...
              <div className="mt-3 flex items-center gap-3 text-[10.5px] text-fg-muted">
                ...
                <div className="flex items-center gap-1">
                  <div className="w-4 h-3 rounded-sm" style={{ backgroundColor: 'rgb(var(--warning) / 0.12)' }} />
                  <span>0.0%</span>
                </div>
                <div className="flex items-center gap-1">
                  <div className="w-4 h-3 rounded-sm" style={{ backgroundColor: 'rgb(var(--warning) / 0.5)' }} />
                  <span>1.5%</span>
                </div>
                <div className="flex items-center gap-1">
                  <div className="w-4 h-3 rounded-sm" style={{ backgroundColor: 'rgb(var(--warning) / 0.9)' }} />
                  <span>3.0%+</span>
                </div>
              </div>
        ...
        <Card className="mb-4">
          ...
          />
          <CardBody>
            <HistogramChart buckets={aprBuckets} medianApr={medianApr} p75Apr={p75Apr} height={200} />
            <div className="mt-2 text-[11.5px] text-fg-muted leading-relaxed">
              ...
              prime/near-prime mix. State-rate-cap-impacted offers (NY, MA, CT) cluster at the 16% cap.
            </div>
          </CardBody>
        </Card>
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-[12.5px]">
                <thead className="bg-bg-muted/40 border-b border-border">
                  <tr>
                    <th className="px-4 py-2 text-left text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Lender</th>
                    <th className="px-4 py-2 text-right text-[10px] uppercase tracking-wider text-fg-muted font-semibold">{tierLabel.prime} <span className="text-fg-muted/60">(700-759)</span></th>
                    <th className="px-4 py-2 text-right text-[10px] uppercase tracking-wider text-fg-muted font-semibold">{tierLabel.near_prime} <span className="text-fg-muted/60">(640-699)</span></th>
                    <th className="px-4 py-2 text-right text-[10px] uppercase tracking-wider text-fg-muted font-semibold">{tierLabel.sub_prime} <span className="text-fg-muted/60">(580-639)</span></th>
                    <th className="px-4 py-2 text-right text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Deep-sub <span className="text-fg-muted/60">(&lt;580)</span></th>
                  </tr>
                </thead>
                <tbody>
                  {lenderTierApr.map((r) => (
                    <tr key={r.lender} className="border-b border-border last:border-b-0">
                      ...
                      <td className="px-4 py-2 text-right tabular-nums">{fmtBps(r.nearPrimeBps)}</td>
          ...
          <Card>
            ...
            <CardBody padded={false}>
              <table className="w-full border-collapse text-[12.5px]">
                <thead className="bg-bg-muted/40 border-b border-border">
                  <tr>
                    <th className="px-4 py-2 text-left text-[10px] uppercase tracking-wider text-fg-muted font-semibold">State</th>
                    <th className="px-4 py-2 text-right text-[10px] uppercase tracking-wider text-fg-muted font-semibold">$ Funded</th>
                    <th className="px-4 py-2 text-right text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Loans</th>
                    <th className="px-4 py-2 text-center text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Status</th>
                  </tr>
                </thead>
                <tbody>
                  {stateCoverage.map((s) => (
                    <tr key={s.code} className="border-b border-border last:border-b-0">
                      <td className="px-4 py-2">
                        <div className="flex items-center gap-2">
                          <span className="inline-flex items-center justify-center w-6 h-6 rounded-sm bg-chart-2/10 text-chart-2 text-[10px] font-bold tabular-nums">{s.code}</span>
                          <span className="font-medium">{s.name}</span>
                        </div>
                      </td>
                      <td className="px-4 py-2 text-right tabular-nums font-medium">{fmtCompactUsd(s.fundedCents)}</td>
                      <td className="px-4 py-2 text-right tabular-nums text-fg-muted">{s.fundedCount}</td>
                      <td className="px-4 py-2 text-center">
            ...
            <CardBody>
              <div className="grid grid-cols-2 gap-3">
                <div className="rounded-md border border-border bg-bg-muted/20 p-3">
                  <div className="text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Orchestrator latency</div>
                  ...
                  <div className="mt-2 text-chart-2"><Sparkline data={seriesL} height={28} /></div>
                </div>
                <div className="rounded-md border border-border bg-bg-muted/20 p-3">
                  <div className="text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Lender API uptime</div>
                  <div className="mt-1.5 text-[20px] font-semibold tabular-nums">99.94%</div>
                  <div className="text-[11px] text-fg-muted mt-0.5">Last incident: 2026-05-09 (ClearPath, 17min)</div>
                  <div className="mt-2 flex items-center gap-2">
                    <StatusPill tone="success" dot>11/12 healthy</StatusPill>
                    <StatusPill tone="warning">1 degraded</StatusPill>
                  </div>
                </div>
                <div className="rounded-md border border-border bg-bg-muted/20 p-3">
                  <div className="text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Webhook delivery</div>
                  <div className="mt-1.5 text-[20px] font-semibold tabular-nums">99.71%</div>
                  <div className="text-[11px] text-fg-muted mt-0.5">3 retries pending · 0 in DLQ</div>
                  <div className="mt-2 text-chart-2"><Sparkline data={[99.6, 99.7, 99.5, 99.8, 99.9, 99.7, 99.6, 99.8, 99.7, 99.71]} height={28} /></div>
                </div>
                <div className="rounded-md border border-border bg-bg-muted/20 p-3">
                  <div className="text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Audit-trail integrity</div>
                  <div className="mt-1.5 text-[20px] font-semibold tabular-nums">PASS</div>
                  <div className="text-[11px] text-fg-muted mt-0.5">Hash-chain verified 2026-05-15 04:00 UTC</div>
                  <div className="mt-2"><StatusPill tone="success" dot>orch_v_2026_05_a · 0 mismatches</StatusPill></div>
                </div>
              </div>
            </CardBody>
          </Card>
        ...
        <Card className="mb-4">
          ...
          <CardBody>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div className="rounded-md border border-border bg-bg-muted/20 p-3">
                <div className="text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Fraud catch rate</div>
                <div className="mt-1.5 text-[22px] font-semibold tabular-nums">94.1%</div>
                <div className="text-[11px] text-fg-muted mt-0.5">vs. 12mo trailing baseline 91.8%</div>
                <div className="text-[11px] text-success mt-1">↑ 2.3pp</div>
              </div>
              <div className="rounded-md border border-border bg-bg-muted/20 p-3">
                <div className="text-[10px] uppercase tracking-wider text-fg-muted font-semibold">False-positive rate</div>
                <div className="mt-1.5 text-[22px] font-semibold tabular-nums">3.2%</div>
                <div className="text-[11px] text-fg-muted mt-0.5">FP downgraded after JIT review</div>
                <div className="text-[11px] text-success mt-1">↓ 0.4pp</div>
              </div>
              <div className="rounded-md border border-border bg-bg-muted/20 p-3">
                <div className="text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Identity-match pass</div>
              ...
              <div className="rounded-md border border-border bg-bg-muted/20 p-3">
                <div className="text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Manual-review queue</div>
                <div className="mt-1.5 text-[22px] font-semibold tabular-nums">28</div>
                <div className="text-[11px] text-fg-muted mt-0.5">Median wait 4.2h · 14d QA = 100%</div>
        ...
        <Card className="mb-4">
          <CardHeader
            ...
            action={
              <div className="flex items-center gap-2">
                <StatusPill tone="success" dot>Within tolerance</StatusPill>
          ...
          <CardBody>
            ...
            <div className="mb-4">
              ...
              <div className="overflow-x-auto">
                <table className="w-full border-collapse text-[12.5px]">
                  <thead className="bg-bg-muted/40 border-b border-border">
                    <tr>
                      <th className="px-3 py-2 text-left text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Dimension</th>
                      <th className="px-3 py-2 text-center text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Age (62+)</th>
                      <th className="px-3 py-2 text-center text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Sex</th>
                      <th className="px-3 py-2 text-center text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Race (BISG)</th>
                      <th className="px-3 py-2 text-center text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Geography</th>
                    </tr>
                  </thead>
                  <tbody>
              ...
              <div className="mt-2 text-[11.5px] text-fg-muted leading-relaxed">
                Geography × approval-rate parity flagged for review — driven by NY rate-cap state where
                fewer prime lenders compete. Disposition note filed; not statistically significant at α=0.05.
              </div>
            </div>
            ...
            <div className="mb-4">
              ...
              <div className="overflow-x-auto">
                <table className="w-full border-collapse text-[12.5px]">
                  <thead className="bg-bg-muted/40 border-b border-border">
                    <tr>
                      <th className="px-3 py-2 text-left text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Class</th>
                      <th className="px-3 py-2 text-right text-[10px] uppercase tracking-wider text-fg-muted font-semibold">ΔTPR</th>
                      <th className="px-3 py-2 text-right text-[10px] uppercase tracking-wider text-fg-muted font-semibold">ΔFPR</th>
                      <th className="px-3 py-2 text-right text-[10px] uppercase tracking-wider text-fg-muted font-semibold">ΔFNR</th>
                      <th className="px-3 py-2 text-center text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Tolerance (0.03)</th>
                    </tr>
                  </thead>
                  <tbody>
                    {equalizedOdds.map((r) => {
                      ...
                      return (
                        <tr key={r.className} className="border-b border-border last:border-b-0">
                          ...
                          <td className="px-3 py-2 text-right tabular-nums">{r.dTpr >= 0 ? '+' : ''}{r.dTpr.toFixed(3)}</td>
                          <td className="px-3 py-2 text-right tabular-nums">{r.dFpr >= 0 ? '+' : ''}{r.dFpr.toFixed(3)}</td>
                          <td className="px-3 py-2 text-right tabular-nums">{r.dFnr >= 0 ? '+' : ''}{r.dFnr.toFixed(3)}</td>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="rounded-md border border-border bg-bg-muted/20 p-4">
                ...
                <div className="text-[12px] text-fg-muted mt-1">Mean time from decline → AAN dispatch</div>
              ...
              <div className="rounded-md border border-border bg-bg-muted/20 p-4">
                ...
                <div className="text-[12px] text-fg-muted mt-1">of overrides QA-reviewed within 14d · 14 last 30d</div>
                  ...
                  {overrideSamples.map((o) => (
                    <div key={o.id} className="border border-border rounded-md p-2 bg-bg-elevated">
                      ...
                      <div className="text-[11.5px] text-fg-secondary">
                        <span className="font-medium">{o.brand}</span> · FICO {o.ficoBand} · reviewed {o.reviewedAt}
                      </div>
                      <div className="text-[11px] text-fg-muted mt-1 leading-snug">{o.rationale}</div>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <Card className="mb-4">
          ...
          <CardBody>
            ...
            <div className="mt-2 grid grid-cols-4 gap-4 text-[11.5px]">
              <div>
                <div className="text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Min</div>
                <div className="font-semibold tabular-nums">{Math.min(...seriesA).toFixed(1)}%</div>
              </div>
              <div>
                <div className="text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Median</div>
                <div className="font-semibold tabular-nums">{([...seriesA].sort((a, b) => a - b)[Math.floor(seriesA.length / 2)] ?? 0).toFixed(1)}%</div>
              </div>
              <div>
                <div className="text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Max</div>
                <div className="font-semibold tabular-nums">{Math.max(...seriesA).toFixed(1)}%</div>
              </div>
              <div>
                <div className="text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Latest</div>
                <div className="font-semibold tabular-nums">{(seriesA[seriesA.length - 1] ?? 0).toFixed(1)}%</div>
              </div>
            </div>
          </CardBody>
        </Card>
          ...
          <CardBody padded={false}>
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-[12px]">
                <thead className="bg-bg-muted/40 border-b border-border">
                  <tr>
                    <th className="px-3 py-2 text-left text-[10px] uppercase tracking-wider text-fg-muted font-semibold">App ID</th>
                    <th className="px-3 py-2 text-left text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Initials</th>
                    <th className="px-3 py-2 text-left text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Brand</th>
                    <th className="px-3 py-2 text-right text-[10px] uppercase tracking-wider text-fg-muted font-semibold">FICO</th>
                    <th className="px-3 py-2 text-right text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Requested</th>
                    <th className="px-3 py-2 text-center text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Decision</th>
                    <th className="px-3 py-2 text-left text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Top reason</th>
                    <th className="px-3 py-2 text-left text-[10px] uppercase tracking-wider text-fg-muted font-semibold">Lender route</th>
                    <th className="px-3 py-2 text-right text-[10px] uppercase tracking-wider text-fg-muted font-semibold">TTD</th>
                  </tr>
                </thead>
                <tbody>
                  {recentDecisions.map((d) => {
                    const decisionTone: StatusTone =
                      d.decision === 'approved' ? 'success' : d.decision === 'declined' ? 'danger' : 'warning';
                    const decisionLabel = d.decision === 'manual_review' ? 'manual' : d.decision;
                    return (
                      <tr key={d.appId} className="border-b border-border last:border-b-0 hover:bg-bg-muted/40">
                        <td className="px-3 py-1.5 font-mono text-[11px] text-fg-muted">app_{d.appId}</td>
                        ...
                        <td className="px-3 py-1.5 text-right tabular-nums">{fmtCompactUsd(d.requestedCents)}</td>
                        <td className="px-3 py-1.5 text-center">
                          <StatusPill tone={decisionTone} dot>{decisionLabel}</StatusPill>
                        </td>
                        <td className="px-3 py-1.5 font-mono text-[11px] text-fg-muted">{d.reason}</td>
                        <td className="px-3 py-1.5 text-fg-secondary">{d.lender}</td>
                        <td className="px-3 py-1.5 text-right tabular-nums text-fg-muted">{d.ttdMs === 0 ? '—' : fmtMs(d.ttdMs)}</td>
                      </tr>
                    );
                  })}
                </tbody>
        ...
        <Card className="mb-4">
          ...
          <CardBody className="space-y-2">
            ...
            <DataRow label="Bureau credit-bureau reconciliation" value="Pass · last verified 2026-05-13" />
            <DataRow label="Model documentation (SR 11-7)" value="Current · last attested 2026-04-22" />
          </CardBody>
        </Card>

        <div className="text-[11px] text-fg-muted leading-relaxed border-t border-border pt-4">
          All charts on this page are derived from the master decisioning event stream. Every row, cell, and
          bar is reproducible from input snapshot + policy version orch_v_2026_05_a. Cohort window: 30 days
          ending 2026-05-15 04:00 UTC. Fair-lending engine runs weekly; quarterly written review is exported
          to the bank-partner audit pack.
        </div>
      </PageBody>
    </>
  );
