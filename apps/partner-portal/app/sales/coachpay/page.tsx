...
const SLIDES_RAW: Slide[] = [
    ...
    build: () => (
      <div className="sld-stack sld-grid-hero">
        <div className="sld-hero-left">
          ...
          <Reveal delay={240}>
            <p className="sld-sub">
              We help executive coaches, mastermind operators, cohort-course creators, consulting
              retainers, and high-ticket health programs close more prospects on the discovery call.
              Soft-pull pre-qualification, marketplace + card-stacking, and merchant-direct funding
  ...
  /* 02 — THE PROBLEM */
  {
    ...
    build: () => (
      <div className="sld-stack">
        ...
        <Reveal delay={240}>
          <p className="sld-sub">
            A $2M-revenue coach loses an estimated{' '}
            <strong>
              $<AnimatedCounter to={1.4} decimals={1} />M a year
            </strong>{' '}
            on qualified discovery calls that ghost after the price reveal. The objection isn&apos;t
            the program. It&apos;s the lump sum. High-ticket prospects don&apos;t carry $24k.
          </p>
        </Reveal>
        <Reveal delay={360}>
          <div className="sld-stat-row">
            <CountStat to={18} suffix="%" k="Industry same-call close (no financing)" />
            <CountStat
              to={1.4}
              decimals={1}
              prefix="$"
              suffix="M"
              k="Enrolment revenue lost / yr"
            />
            <CountStat to={62} suffix="%" k="Discovery calls that ghost after price" />
            <CountStat label="4–8 wks" k="Lead → enrol (cash-pay)" />
          </div>
        </Reveal>
        <Reveal delay={480}>
  ...
  /* 03 — WHY NOW */
  {
    ...
    build: () => (
      <div className="sld-stack">
        ...
        <Reveal delay={240}>
          <p className="sld-sub">
            Affirm and Klarna proved consumers want financing — but they were built for retail
            cart-level BNPL on physical goods. They cap below $5k, decline on the second-look, and
            don&apos;t understand the discovery-call sales motion. In-house Voxer payment plans tie
            up your A/R and force you to chase delinquencies. CoachPay solves the ceiling.
          </p>
        </Reveal>
        <Reveal delay={360}>
          <div className="sld-vs-2col">
            <div className="sld-vs-side sld-vs-quo">
              <div className="sld-vs-eyebrow">Affirm · Klarna · in-house plans</div>
              <ul>
                <li>
                  <span className="sld-vs-icon sld-vs-x">×</span> Retail BNPL — caps below $5k
                </li>
                <li>
                  <span className="sld-vs-icon sld-vs-x">×</span> Single underwriter · decline =
                  walks
                </li>
                <li>
                  <span className="sld-vs-icon sld-vs-x">×</span> Voxer payment plans tie up A/R
                </li>
                <li>
                  <span className="sld-vs-icon sld-vs-x">×</span> No card-stacking for $35k
                  masterminds
                </li>
              </ul>
            </div>
            <div className="sld-vs-side sld-vs-med">
              <div className="sld-vs-eyebrow accent">CoachPay marketplace + card stack</div>
              <ul>
                <li>
                  <span className="sld-vs-icon sld-vs-check">✓</span> Personal-loan lenders in
                  parallel · $5k–$50k
                </li>
                <li>
                ...
                <li>
                  <span className="sld-vs-icon sld-vs-check">✓</span> Card-stacking for $35k+
                  flagship tickets
                </li>
              </ul>
            </div>
  ...
  /* 04 — WHAT MEDPAY IS */
  {
    ...
    build: () => (
      <div className="sld-stack">
        ...
        <Reveal delay={240}>
          <p className="sld-sub">
            Three things matter on a high-ticket discovery call. CoachPay nails all three.
          </p>
        </Reveal>
        <Reveal delay={360}>
          <div className="sld-pillars">
            <Pillar
              n="01"
              head="Same-call qualification"
              metric="< 10s"
              body="Prospect runs the soft pull while still on Zoom. Closer sees the fundability tier on screen, pivots the close in real time. No hard pull until the prospect picks an offer."
              tags={['Soft pull', 'FCRA', 'Live on Zoom']}
            />
            <Pillar
              n="02"
            ...
            <Pillar
              ...
              head="Cash flow"
              metric="48–72 hr"
              body="Lender disburses straight to your business account. No Voxer collection chasing. Lender holds the credit risk: if a student quits mid-program, that's your refund decision — never a clawback liability."
    ...
    build: () => (
      <div className="sld-stack sld-grid-hero">
        <div className="sld-hero-left">
          ...
          <Reveal delay={240}>
            <p className="sld-sub">
              Closer drops a single link in Zoom chat. Prospect taps four fields on their phone —
              fundability tier returns before the closer finishes the next slide. No hard pull, so
              the prospect can still walk away with zero credit consequence.
            </p>
          </Reveal>
          <Reveal delay={360}>
            <div className="sld-mini-stats">
              ...
              <MiniStat v="On Zoom" k="Live during the call" />
            </div>
          </Reveal>
          <Reveal delay={480}>
            <p className="sld-takeaway">
              For the closer: the prospect already knows they qualify before you reveal the price.
              The next sentence is &ldquo;here&apos;s your enrolment paperwork,&rdquo; not
              &ldquo;let me know if you can swing it.&rdquo;
            </p>
          </Reveal>
        </div>
        <div className="sld-hero-right">
  ...
  /* 07 — STAGE 3: MARKETPLACE */
  {
    ...
    build: () => (
      <div className="sld-stack">
        ...
        <Reveal delay={120}>
          <h2 className="sld-h2">
            <span className="grad-teal-deep">Six personal-loan lenders.</span>{' '}
            <span className="grad-teal">Plus card-stacking.</span>{' '}
            <span className="grad-teal-deep">All in parallel.</span>
          </h2>
        </Reveal>
        <Reveal delay={240}>
          <p className="sld-sub">
      ...
      <div className="sld-stack">
        ...
        <Reveal delay={120}>
          <h2 className="sld-h2">
            ...
            <span className="grad-teal">Prospect enrols on the call.</span>
          </h2>
        </Reveal>
        <Reveal delay={240}>
          <p className="sld-sub">
            Three ranked offers on the prospect&apos;s screen mid-Zoom. Sorted by lowest monthly,
            not commission. Starred row is what 80% of qualified prospects pick. Closer walks them
            through it live. E-signature in the browser. Enrolment confirmed before the call ends.
          </p>
        </Reveal>
        <Reveal delay={360}>
          <OfferStack />
        ...
        <Reveal delay={120}>
          <h2 className="sld-h2">
            <span className="grad-teal">
              <AnimatedCounter to={18} suffix="%" /> same-call closes
            </span>{' '}
            <span className="grad-teal-deep">
              becomes <AnimatedCounter to={55} suffix="%+" delay={400} /> enrolled on Zoom.
            </span>
          </h2>
        </Reveal>
        <Reveal delay={240}>
  ...
  /* 21 — VERTICAL: EXECUTIVE COACHING */
  {
    ...
    build: () => (
      <VerticalSlide
        ...
        headline={
          <>
            <span className="grad-teal-deep">For 1:1 executive operators,</span>{' '}
            <span className="grad-teal">founder mentors, and leadership intensives.</span>
          </>
        }
        intro="Executive coaching is CoachPay's anchor vertical. 12-month founder programs, leadership intensives, performance retreats — the discovery calls where the prospect hears $24k for the program and has to decide whether to enrol before the close window closes."
        ...
        outcomes={[
          { v: '2.1×', k: 'Same-call enrol uplift' },
  ...
  /* 22 — VERTICAL: MASTERMINDS + COHORTS */
  {
    n: '22',
      ...
      <VerticalSlide
        ...
        headline={
          <>
            ...
            <span className="grad-teal">Card-stacking for $35k tickets.</span>
          </>
        }
        intro="Masterminds sell premium cohorts: 12-month peer programs, quarterly retreats, in-person intensives. The math only works if prospects commit upfront. CoachPay turns single-call discovery into cohort-funded enrolments — including $35k flagship tiers that card-stack across 3 cards + 1 loan."
        ...
        pains={[
          ...
          'Voxer payment plans tie up A/R · 12-month carry on every enrolment',
          'Single-lender financing declines mid-prime → losing 30%+ of qualified pipeline',
          '$35k flagship tier sits in "I need to find the cash" purgatory',
        ]}
        outcomes={[
        ...
        quote="Stopped chasing payment plans over Voxer. The agentic layer pre-qualified 480 prospects last quarter and routed every Tier-1 lead to the right closer without anyone asking. ECHO suppressed junk traffic so the ad account learns from the closers, not every cold click."
  ...
  /* 23 — VERTICAL: COURSE · CONSULTING · HEALTH */
  {
    ...
    build: () => (
      <VerticalSlide
        ...
        intro="Cohort-based courses, done-with-you consulting retainers, and high-ticket health + performance programs. Same soft-pull, same marketplace + card-stack, same merchant-direct payout — just the program story changes."
        ...
        pains={[
          'Cohort-based course: prospects bounce on the 5-figure ticket reveal',
          'Consulting retainer: $40k upfront blocks otherwise-qualified buyers',
          'Health & performance: longevity programs sit in "save for later" trap',
          'All three: Affirm / Klarna cap out and Stripe Capital is for the business, not the buyer',
        ]}
        outcomes={[
...
function MarketplaceViz(): JSX.Element {
  ...
  const QUOTES = [
    { lender: 'LendingPoint', apr: '11.99%', mo: '$398', term: '60', winner: true },
    { lender: 'Upgrade', apr: '12.49%', mo: '$408', term: '60' },
    { lender: 'Best Egg', apr: '13.99%', mo: '$436', term: '60' },
    { lender: 'Marcus · Goldman', apr: '14.99%', mo: '$456', term: '60' },
    { lender: 'Lightstream', apr: '15.99%', mo: '$477', term: '60' },
    { lender: 'Card-stack (3 cards)', apr: '0% promo', mo: '$520', term: '18' },
  ];
  return (
    <div className="sld-mp">
      ...
      <div className="sld-mp-quotes">
        ...
        <div className="sld-mp-quotes-foot">
          ...
          <span className="sld-mp-quotes-foot-v">$398/mo · 60 mo · LendingPoint</span>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="sld-bar-race">
      <div className="sld-bar-row">
        <div className="sld-bar-label">Without CoachPay (18% same-call close)</div>
        <div className="sld-bar-track">
          <div className="sld-bar-fill without" style={{ width: '18%' }}>
            <span>18%</span>
          </div>
        </div>
      </div>
      <div className="sld-bar-row">
        <div className="sld-bar-label">With CoachPay (55%+ same-call enrol · illustrative)</div>
        <div className="sld-bar-track">
          <div className="sld-bar-fill with" style={{ width: '55%' }}>
            <span>55%+</span>
          </div>
        </div>
      </div>
      <div className="sld-bar-delta">
        ...
        <span className="sld-bar-delta-val">+37 pts same-call enrol rate</span>
...
function VsTable(): JSX.Element {
  const rows = [
    {
      k: 'Built for high-ticket coaching',
      single: 'No — retail BNPL on physical goods',
      med: 'Yes — purpose-built for $5k–$50k programs',
    },
    {
      k: 'Ticket range',
      single: 'Affirm / Klarna cap below $5k',
      med: '$5,000 to $50,000 · marketplace + card-stack',
    },
    {
      k: 'Decline = prospect walks',
      single: 'Yes — single underwriter',
    ...
    },
    {
      ...
      single: 'Apply on phone after the call',
      med: 'Soft pull live on Zoom · closer sees tier in real time',
    },
    {
      k: 'A/R + collection',
      single: 'In-house Voxer plans · you carry the risk',
      med: 'Lender carries credit risk · no clawback',
    },
    {
      k: 'Agent layer',
      single: 'None',
    ...
    {
      k: 'Pixel attribution',
      single: 'Fires on form-fill (junk training signal)',
      med: 'ECHO fires on funded enrolment (real buyer signal)',
    },
  ];
  return (
    <table className="sld-vs-table">
      <thead>
        <tr>
          <th></th>
          <th>Affirm · Klarna · in-house Voxer plans · Stripe Capital</th>
          <th className="accent">CoachPay marketplace + card stack</th>
        </tr>
      </thead>
      <tbody>
        {rows.map((r, i) => (
      ...
      <div className="sld-ipad-bezel">
        <div className="sld-ipad-screen">
          ...
          <div className="sld-ipad-form">
            {[
              { k: 'Last 4 of SSN', v: '••••' },
              { k: 'Date of birth', v: '08 / 21 / 1988' },
              { k: 'Annual income', v: '$185,000' },
              { k: 'Mailing address', v: '108 Spring St, New York NY' },
            ].map((f, i) => (
...
function OfferStack(): JSX.Element {
  const offers = [
    { lender: 'LendingPoint', monthly: '$398', term: '60 mo', tag: 'Lowest monthly', star: true },
    { lender: 'Upgrade', monthly: '$408', term: '60 mo', tag: '2nd cheapest' },
    { lender: 'Best Egg', monthly: '$436', term: '60 mo', tag: '3rd' },
  ];
  return (
...
function Storyboard(): JSX.Element {
  const panels: Array<{
  ...
  }> = [
    {
      n: '01',
      t: 'Enter info',
      b: 'Closer drops a link in Zoom chat. Prospect taps SSN-4, DOB, income, address on their phone — done before the closer finishes the next slide.',
      meta: 'On Zoom',
      glyph: (
    ...
    },
    {
      n: '03',
      t: 'See offers',
      b: 'Three ranked offers on the prospect screen. Cheapest monthly first. Closer walks them through it live.',
      meta: '3 offers',
      glyph: (
        <svg viewBox="0 0 32 32" aria-hidden>
          <rect
    ...
    },
    {
      n: '04',
      t: 'Enrol live',
      b: 'Prospect e-signs in Zoom. Funds wire merchant-direct in 48-72 hours. Enrolment confirmed.',
      meta: '48–72 hr',
      glyph: (
        <svg viewBox="0 0 32 32" aria-hidden>
          <path
...
function MoneyBreakdown(): JSX.Element {
  // Quiet purple-only breakdown of where the $1.41M leaks for a $2M coach.
  const rows = [
    {
      k: 'Lost enrolments',
      sub: '~52 ghosted discovery calls/yr · $18k avg program · 90%',
      v: '$842,400',
      pct: '60.2%',
    },
    {
      k: 'Wasted closer hours',
      sub: '~6 unfit discovery calls/wk · 45min · $350/hr × 52',
      v: '$409,500',
      pct: '29.3%',
    },
    {
      k: 'Payment-plan A/R + Voxer chasing',
      sub: '~8 in-house instalment plans/mo · 2hr/mo chasing · 12mo carry',
      v: '$148,000',
      pct: '10.5%',
    },
  ];
  return (
    <div className="sld-money">
      ...
      <div className="sld-money-row sld-money-row-total">
        ...
        <div className="sld-money-row-r">
          <div className="sld-money-row-v sld-money-row-v-total">$1.40M</div>
        </div>
      </div>
    </div>
  );
      ...
      <div className="sld-funnel-branches">
        <div className="sld-funnel-branch sld-funnel-branch-high">
          <div className="sld-funnel-branch-head">
            <span className="sld-funnel-branch-tag">FLAGSHIP TIER</span>
            <span className="sld-funnel-branch-crit">≥ 700 · ≥ $10k available · DTI &lt; 40%</span>
          </div>
          <ol className="sld-funnel-branch-steps">
            <li>
              <span className="sld-funnel-step-n">01</span>
              <span className="sld-funnel-step-h">Filter by credit + DTI</span>
            </li>
            <li>
            ...
            <li>
              ...
              <span className="sld-funnel-step-h">Stack cards if &gt; $25k ticket</span>
            </li>
          </ol>
          <div className="sld-funnel-branch-outcome">Enrolled on the call · funded</div>
        </div>

        <div className="sld-funnel-branch sld-funnel-branch-low">
          <div className="sld-funnel-branch-head">
            <span className="sld-funnel-branch-tag">STARTER / NURTURE</span>
            <span className="sld-funnel-branch-crit">Below floor · still warm</span>
          </div>
          <ol className="sld-funnel-branch-steps">
            <li>
              <span className="sld-funnel-step-n">01</span>
              <span className="sld-funnel-step-h">Offer starter program / book</span>
            </li>
            <li>
              <span className="sld-funnel-step-n">02</span>
              <span className="sld-funnel-step-h">$99 audit or $497 mini-course</span>
            </li>
            <li>
              <span className="sld-funnel-step-n">03</span>
              <span className="sld-funnel-step-h">Re-pull in 90 days · credit recovery</span>
            </li>
          </ol>
          <div className="sld-funnel-branch-outcome sld-funnel-branch-outcome-low">
            Routed back to flagship tier
          </div>
        </div>
      </div>
    </div>
...
function WhoIsItFor(): JSX.Element {
  ...
  return (
    <div className="sld-stack">
      ...
      <Reveal delay={240}>
        <p className="sld-sub">
          Anywhere a prospect hops on a discovery call, hears a 5-figure number, and has to decide
          on the spot &mdash; that&apos;s our sweet spot. Five verticals today. Same platform, same
          flow, same merchant-direct payout. Just the case stories change.
        </p>
      </Reveal>
      <Reveal delay={360}>
...
function SixAgents(): JSX.Element {
  ...
  const agents: Array<{
  ...
  }> = [
    {
      ...
      watches: 'Reporting-bureau soft pull during every discovery call',
      output: 'Credit · DTI · available credit · pre-approval $ · card-stack ceiling',
      version: 'v4.2',
      glyph: (
    ...
    {
      code: 'HELIX',
      role: 'Smart intake + closer routing',
      watches: 'Form behaviour + program tier + closer capacity',
      output: 'Routes T1 prospects to top closers · re-qualifies near-prime',
      version: 'v3.8',
      glyph: (
        <svg viewBox="0 0 40 40" aria-hidden>
          <path
    ...
    },
    {
      ...
      watches: 'Approval rates · funding pull-through · 0% promo windows',
      output: 'Optimal lender sequence per prospect profile + ticket',
      version: 'v2.5',
      glyph: (
        <svg viewBox="0 0 40 40" aria-hidden>
          <path
    ...
    },
    {
      ...
      watches: 'Funded-enrolment signal · CAPI server-side · per-program ROAS',
      output: 'Re-trains Meta + Google + TikTok on real funded buyers',
      version: 'v5.0',
      glyph: (
        <svg viewBox="0 0 40 40" aria-hidden>
          <circle cx="20" cy="20" r="3" fill="currentColor" />
...
function CompoundEffect(): JSX.Element {
  // 12 monthly points · cumulative recovered enrolment revenue ($ thousands)
  // $2M-revenue coach scaling on a $15k average program ticket.
  const months = [
    { m: 'M01', rev: 95, cpa: 0 },
    { m: 'M02', rev: 200, cpa: -4 },
    { m: 'M03', rev: 315, cpa: -9 },
    { m: 'M04', rev: 440, cpa: -14 },
    { m: 'M05', rev: 575, cpa: -19 },
    { m: 'M06', rev: 720, cpa: -25 },
    { m: 'M07', rev: 875, cpa: -29 },
    { m: 'M08', rev: 1040, cpa: -32 },
    { m: 'M09', rev: 1215, cpa: -34 },
    { m: 'M10', rev: 1400, cpa: -36 },
    { m: 'M11', rev: 1595, cpa: -37 },
    { m: 'M12', rev: 1800, cpa: -38 },
  ];
  ...
  return (
    <div className="sld-stack">
      ...
      <Reveal delay={240}>
        <p className="sld-sub">
          CoachPay does not just close more prospects on today&apos;s discovery call. It compounds.
          Each funded enrolment re-trains your pixel. Meta and Google start sending prospects who
          actually buy at 5-figures, not list-builders. Better leads enrol at a higher rate. The
          cycle accelerates. Twelve months in, the business is unrecognisable.
        </p>
      </Reveal>
      <Reveal delay={360}>
        <div className="sld-comp-chart">
          ...
          <div className="sld-comp-legend">
            <div>
              <div className="sld-comp-legend-k">Cumulative recovered enrolment revenue</div>
              <div className="sld-comp-legend-v">
                ~$1.8M by month 12 · $2M-revenue coach · illustrative
              </div>
            </div>
            <div>
      ...
      <Reveal delay={480}>
        <div className="sld-mini-stats">
          <MiniStat v="~$1.8M" k="Cum. enrolment revenue / yr" />
          <MiniStat v="−38%" k="CPA by month 12" />
          <MiniStat v="2.4×" k="Funded enrolments / $1k ad spend" />
          <MiniStat v="+27%" k="Discovery-to-enrol rate (vs. M01)" />
        </div>
      </Reveal>
    </div>
  );
...
function ValueStack(): JSX.Element {
  const groups: Array<{ head: string; items: string[]; alt: string }> = [
    ...
    },
    {
      ...
      items: [
        'HELIX best-fit closer routing',
        'Tier + capacity + program-fit matching',
        'Smartphone continuity for off-call e-sign',
...
function EconomicsSlide(): JSX.Element {
  // Defaults tuned for a $2M-revenue coach: 80 discovery calls/month,
  // ~60% show + qualify, $15k average program ticket (12-month exec coaching
  // / mid-tier mastermind). Close rates: 18% baseline same-call close, 55%
  // with CoachPay. 80% of accepted offers actually fund (some prospects
  // back out, some lenders pull stips at funding).
  const [leads, setLeads] = useState(80);
  const [qualPct, setQualPct] = useState(60);
  const [ticket, setTicket] = useState(15000);
  const [closeWithout, setCloseWithout] = useState(18);
  const [closeWith, setCloseWith] = useState(55);
