  ...
  /* 17 — ONBOARDING */
  {
    ...
    build: () => (
      <div className="sld-stack">
        ...
        <Reveal delay={200}>
          <p className="sld-sub">
            Once you sign and the $5,000 platform fee clears, our team configures the account,
      ...
      <div className="sld-stack">
        ...
        <Reveal delay={360}>
          <div className="sld-cta-grid">
            <a href="/medpay/checkout?plan=5k" className="sld-cta sld-cta-primary">
  ...
  return (
    <div className="sld-invoice">
      ...
      <div className="sld-invoice-foot">
        $5,000 setup is one-time. After that you only pay $3 per smart-form lead and 4% of loans
        ...
        <div className="sld-stack-total">
          ...
          <div className="sld-stack-total-row accent">
            ...
            <span className="sld-stack-total-v">
              $5,000 one-time · $3 / lead · 4% of settled loans
            </span>
          </div>
        </div>
      </Reveal>
    ...
    <div className="sld-stack sld-finale">
      ...
      <Reveal delay={240}>
        <p className="sld-sub sld-finale-sub">
          $5,000 to set up. $3 per smart-form lead. 4% of loans that actually settle. Live in up to
          five business days. 1,000+ practices already running on MedPay.
        </p>
      </Reveal>
      <Reveal delay={360}>
        <div className="sld-finale-ctas sld-finale-ctas-single">
          <a href="/medpay/checkout?plan=5k" className="sld-finale-primary">
            <span className="sld-finale-primary-h">Get started · $5,000</span>
      ...
      <Reveal delay={480}>
        <div className="sld-finale-trust">
          NMLS&nbsp;#2456701 · FCRA · ECOA · TILA · 1,000+ practices · $5k setup · $3 / lead · 4%
          settled
        </div>
      </Reveal>
    </div>
