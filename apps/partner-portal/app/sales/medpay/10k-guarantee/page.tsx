      ...
      <div className="sld-stack">
          ...
          <div className="sld-pricing-stack">
            <div className="sld-pricing-tier sld-pricing-tier-hero">
              <div className="sld-pricing-tier-l">
                <div className="sld-pricing-tier-tag">01 · PLATFORM SETUP · 10x GUARANTEE</div>
                <div className="sld-pricing-tier-h">
                  $5,000 today. $5,000 in 90 days &mdash; only if we deliver.
                </div>
                <div className="sld-pricing-tier-b">
                  Full configuration, agent training, marketplace activation, partner-portal
                  provisioning. If we don&apos;t fund $50,000+ in patient loans for your practice in
                  the first 90 days, the second $5,000 is waived. Hit the threshold (which means
                  we&apos;ve already 10x&apos;d your investment), the second $5,000 is invoiced.
                </div>
              </div>
        ...
        <Reveal delay={360}>
          <div className="sld-pricing-foot">
            ...
            <div className="sld-pricing-foot-row">
              <span className="sld-pricing-foot-k">90-day funding threshold</span>
              <span className="sld-pricing-foot-v">$50,000 in patient loan settlements</span>
            </div>
            <div className="sld-pricing-foot-row">
              <span className="sld-pricing-foot-k">Your worst-case spend</span>
              <span className="sld-pricing-foot-v">$5,000 · period</span>
            </div>
          </div>
        </Reveal>
      </div>
  ...
  /* 17 — ONBOARDING */
  {
    ...
    build: () => (
      <div className="sld-stack">
        ...
        <Reveal delay={200}>
          <p className="sld-sub">
            Once you sign and the $5,000 today-payment clears, our team configures the account,
  ...
  return (
    <div className="sld-invoice">
      ...
      <table className="sld-invoice-table">
        ...
        <tbody>
          <tr>
            <td>MedPay platform · setup payment 1 of 2</td>
            <td>1</td>
            <td>$5,000</td>
            <td>$5,000.00</td>
          </tr>
      ...
      <div className="sld-invoice-foot">
        $5,000 today. Second $5,000 invoiced on day 90 only if we fund $50,000+ in patient loans.
        After setup, $3 per smart-form lead and 4% of loans that actually settled.
      </div>
    </div>
  );
}
        ...
        <div className="sld-stack-total">
          ...
          <div className="sld-stack-total-row accent">
            ...
            <span className="sld-stack-total-v">
              $5,000 today · $5,000 day 90 (only if we fund $50k+) · $3 / lead · 4% of settled loans
            </span>
          </div>
        </div>
      </Reveal>
    ...
    <div className="sld-stack sld-finale">
      ...
      <Reveal delay={240}>
        <p className="sld-sub sld-finale-sub">
          $5,000 today. $5,000 in 90 days &mdash; only if we fund $50,000+ in patient loans for you.
          If we don&apos;t, the second $5,000 is waived. 10x guarantee. $3 per smart-form lead. 4%
          of loans that actually settle. Live in five business days.
        </p>
      </Reveal>
      <Reveal delay={360}>
