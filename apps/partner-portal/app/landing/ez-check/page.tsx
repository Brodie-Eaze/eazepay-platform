/**
 * EZ Check · Landing page (/landing/ez-check)
 *
 * Marketing surface for the standalone pre-qualification product.
 * Same "AUREAN-style" visual benchmark as /landing/medpay but in
 * sky-blue / slate, with a much tighter narrative arc because EZ
 * Check is a single capability (pre-qual + smart form + smart
 * routing), not a lender marketplace.
 *
 * The funnel:
 *   /landing/ez-check  →  /sales/ez-check  →  /ez-check/checkout
 *                                          →  /ez-check/onboarding
 *
    ...
    <div className="ezl-root">
      ...
      <header className="ezl-nav">
        <div className="ezl-container ezl-nav-inner">
          <Link href="/landing/ez-check" className="ezl-brand" aria-label="EZ Check home">
          ...
          <div className="ezl-nav-cta-group">
            <Link href="/sales/ez-check" className="ezl-nav-link">
              Sales deck
            </Link>
            <Link href="/ez-check/checkout" className="ezl-btn-primary">
            ...
            <div className="ezl-hero-l">
              ...
              <Reveal delay={480}>
                <div className="ezl-hero-cta-row">
                  <Link href="/ez-check/checkout" className="ezl-btn-primary ezl-btn-lg">
                    Activate EZ Check {Icon.arrow()}
                  </Link>
                  <Link href="/sales/ez-check" className="ezl-btn-ghost ezl-btn-lg">
            ...
            <Reveal>
              <div className="ezl-cta-card">
                ...
                <div className="ezl-cta-actions">
                  <Link href="/ez-check/checkout" className="ezl-btn-primary ezl-btn-xl">
                    Activate now · $5,000 {Icon.arrow()}
                  </Link>
                  <Link href="/sales/ez-check" className="ezl-btn-ghost ezl-btn-xl">
      ...
      <footer className="ezl-footer">
        <div className="ezl-container ezl-footer-inner">
          ...
          <div className="ezl-footer-links">
            ...
            <Link href="/ez-check/checkout">Pricing</Link>
            <Link href="/ez-check/onboarding">Onboarding</Link>
