...
export default function MedPayVideoV14(): JSX.Element {
  return (
    <VideoStage
      css={`
        ${SHARED_CHROME_CSS}
        ...
        .v14-a1-pre {
          ...
          opacity: 0;
          animation: v14-blur-in 0.5s 0.4s forwards;
        }
        .v14-a1-h {
          position: absolute;
          top: 680px;
          ...
          opacity: 0;
          animation: v14-blur-in 0.6s 0.9s forwards;
        }
        .v14-a1-h em {
          font-style: normal;
          color: ${TEAL_2};
        ...
        .v14-a3-step:nth-child(1) {
          animation: v14-pop-in 0.5s 4.4s forwards;
        }
        .v14-a3-step:nth-child(2) {
          animation: v14-pop-in 0.5s 5.4s forwards;
        }
        .v14-a3-step:nth-child(3) {
          animation: v14-pop-in 0.5s 6.4s forwards;
        }
        .v14-a3-step:nth-child(4) {
          animation: v14-pop-in 0.5s 7.4s forwards;
        }
        .v14-a3-step.is-bad {
        ...
        .v14-a3-tally {
          ...
          border-radius: 20px;
          opacity: 0;
          animation: v14-pop-in 0.5s 8.4s forwards;
        }
        .v14-a3-tally-h {
          font-size: 38px;
          font-weight: 800;
        ...
        .v14-tree-node.is-root .v14-tree-node-h,
        .v14-tree-node.is-traced .v14-tree-node-h {
          fill: #fff;
        }
        ...
        .v14-a5-tally {
          ...
          border-radius: 20px;
          opacity: 0;
          animation: v14-pop-in 0.5s 18.6s forwards;
        }
        .v14-a5-tally-h {
          font-size: 34px;
          font-weight: 800;
        ...
        .v14-a7 {
          ...
          inset: 0;
          opacity: 0;
          animation: v14-blur-in 0.6s 22s forwards;
        }
        .v14-a7-pre {
          position: absolute;
          top: 680px;
    ...
    >
      ...
      {/* ─── ACT 1 hook · quote / objection variant ───────────────────── */}
      <section className="v14-a1">
        <div className="v14-a1-pre">Your closer hates this call</div>
        <h1 className="v14-a1-h">
          &ldquo;I&apos;m just looking <em>for info.</em>&rdquo;
        </h1>
        <div className="v14-a1-sub">
          <em>MedPay</em> filters these out before your closer dials.
        </div>
      </section>

      {/* ─── ACT 2 tag ─────────────────────────────────────────────────── */}
      <section className="v14-a2">
        <h2 className="v14-a2-h">
          Here&apos;s how <em>most do it today.</em>
        </h2>
      </section>

      {/* ─── ACT 3 today's funnel ──────────────────────────────────────── */}
      <section className="v14-a3">
        <div className="v14-a3-tag">Today&apos;s funnel</div>
        <h3 className="v14-a3-h">Your day, every day.</h3>
        <div className="v14-a3-steps">
          <div className="v14-a3-step">
            <div className="v14-a3-num">1</div>
            <div className="v14-a3-body">
              <div className="v14-a3-h2">Lead fills your form.</div>
              <div className="v14-a3-b">Name, email, maybe a phone number.</div>
            </div>
            <div></div>
          </div>
          <div className="v14-a3-step is-bad">
            <div className="v14-a3-num">2</div>
            <div className="v14-a3-body">
              <div className="v14-a3-h2">Your closer dials every one.</div>
              <div className="v14-a3-b">No idea who can pay. Calls the whole list.</div>
            </div>
            <div className="v14-a3-pill">80 dials</div>
          </div>
          <div className="v14-a3-step is-bad">
            <div className="v14-a3-num">3</div>
            <div className="v14-a3-body">
              <div className="v14-a3-h2">Hours on unqualified buyers.</div>
              <div className="v14-a3-b">
                &ldquo;Just info.&rdquo; &ldquo;Can&apos;t afford.&rdquo; &ldquo;Maybe later.&rdquo;
              </div>
            </div>
            <div className="v14-a3-pill">~6 hrs</div>
          </div>
          <div className="v14-a3-step is-bad">
            <div className="v14-a3-num">4</div>
            <div className="v14-a3-body">
              <div className="v14-a3-h2">A few cases close.</div>
              <div className="v14-a3-b">The rest ghost, cancel, or decline at checkout.</div>
            </div>
            <div className="v14-a3-pill">Few</div>
          </div>
        </div>
        <div className="v14-a3-tally">
          <div className="v14-a3-tally-h">
      ...
      {/* ─── ACT 4 pivot ───────────────────────────────────────────────── */}
      <section className="v14-a4">
        <h2 className="v14-a4-h">
          Now here&apos;s <em>MedPay.</em>
        </h2>
      </section>

      {/* ─── ACT 5 MedPay routing tree ─────────────────────────────────── */}
      <section className="v14-a5">
        <div className="v14-a5-tag">The MedPay way · high-ticket flow</div>
        <h3 className="v14-a5-h">
          Qualified buyers sell. <em>The rest get a guide.</em>
        </h3>
        <div className="v14-tree">
          <svg
            viewBox="0 0 1000 1200"
            preserveAspectRatio="xMidYMid meet"
            className="v14-tree-svg"
            aria-label="MedPay high-ticket routing tree"
          >
            {/* solid teal edges along the qualified path */}
            <g className="v14-tree-edges-solid">
              {/* root to credit gate */}
            ...
            <g className="v14-tree-edges-solid" style={{ opacity: 0.55 }}>
            ...
            <path
              ...
              stroke="none"
            />
            <path id="v14-trace-cfail" d="M280,55 L280,230 L740,230" fill="none" stroke="none" />
            <path
              id="v14-trace-ifail"
            ...
            {/* L0 · lead capture */}
            <g className="v14-tree-node is-root">
              <rect x="150" y="20" width="260" height="80" rx="14" />
              <text className="v14-tree-node-tag" x="280" y="52">
                LEAD CAPTURE
              </text>
              <text className="v14-tree-node-h" x="280" y="82">
                Form submit
              </text>
            </g>

            {/* L1 · credit score gate */}
            <g className="v14-tree-node is-traced">
              <rect x="150" y="180" width="260" height="100" rx="14" />
              <text className="v14-tree-node-tag" x="280" y="212">
                HOP 1 · CREDIT SCORE
              </text>
              <text className="v14-tree-node-h" x="280" y="254" style={{ fontSize: 30 }}>
                ≥ 700?
              </text>
            </g>
            {/* L1 NO branch · send guide */}
            <g className="v14-tree-node">
              <rect x="580" y="180" width="320" height="100" rx="14" />
              <text className="v14-tree-node-tag" x="740" y="212">
                NO · SEND GUIDE
              </text>
              <text className="v14-tree-node-h" x="740" y="248" style={{ fontSize: 22 }}>
                Credit-building guide
              </text>
              <text
                className="v14-tree-node-tag"
                x="740"
                y="270"
            ...
            <g className="v14-tree-node is-traced">
              ...
              <text className="v14-tree-node-tag" x="280" y="392">
                HOP 2 · INCOME
              </text>
              <text className="v14-tree-node-h" x="280" y="434" style={{ fontSize: 30 }}>
                ≥ $80k?
              </text>
            </g>
            ...
            <g className="v14-tree-node">
              ...
              <text className="v14-tree-node-tag" x="740" y="392">
                NO · SEND GUIDE
              </text>
              <text className="v14-tree-node-h" x="740" y="428" style={{ fontSize: 22 }}>
                Planning guide
              </text>
              <text
                className="v14-tree-node-tag"
            ...
            <g className="v14-tree-node is-traced">
              ...
              <text className="v14-tree-node-tag" x="280" y="580" style={{ fontSize: 14 }}>
                SALES CALL
              </text>
              <text className="v14-tree-node-h" x="280" y="630" style={{ fontSize: 32 }}>
                Qualified buyer
              </text>
              <text
                className="v14-tree-node-tag"
            ...
            <g className="v14-tree-node is-traced">
              ...
              <text className="v14-tree-node-tag" x="280" y="832">
                LENDER MARKETPLACE
              </text>
              <text className="v14-tree-node-h" x="280" y="874" style={{ fontSize: 20 }}>
            ...
            <g className="v14-tree-node is-traced">
              ...
              <text className="v14-tree-node-tag" x="280" y="1012">
                OUTCOME
              </text>
              <text className="v14-tree-node-h" x="280" y="1054" style={{ fontSize: 34 }}>
                Funded.
              </text>
            </g>

            {/* multiple leads streaming through the tree in real time */}
            <circle r="14" className="v14-tree-orb">
              <animateMotion dur="7s" begin="11.5s" fill="freeze">
                <mpath href="#v14-trace-qual" />
              </animateMotion>
            </circle>
            <circle r="14" className="v14-tree-orb">
              <animateMotion dur="2.5s" begin="12.4s" fill="freeze">
                <mpath href="#v14-trace-cfail" />
              </animateMotion>
            </circle>
            <circle r="14" className="v14-tree-orb">
        ...
        <div className="v14-a5-tally">
          <div className="v14-a5-tally-h">
      ...
      {/* ─── ACT 6 result ──────────────────────────────────────────────── */}
      <section className="v14-a6">
        <h2 className="v14-a6-h">
        ...
        <div className="v14-a6-sub">No more wasted hours.</div>
      </section>

      {/* ─── ACT 7 stamp ───────────────────────────────────────────────── */}
      <section className="v14-a7">
        <div className="v14-a7-pre">That&apos;s</div>
        <h2 className="v14-a7-h">MedPay.</h2>
      </section>
