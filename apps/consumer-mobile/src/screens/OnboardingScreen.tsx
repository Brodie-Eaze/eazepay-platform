...
export default function OnboardingScreen({ navigation }: Props) {
  return (
    <SafeAreaView style={s.safe}>
      ...
      <Text style={s.body}>
        Before your first application, we'll verify your identity. We use a third-party
        provider (Persona / Socure) — your image and SSN go directly to them, never to us.
      </Text>
...
const s = StyleSheet.create({
  ...
  h1: { fontSize: fontSizes.h2, fontWeight: '700', color: lightColors.textPrimary, marginTop: spacing.giant, marginBottom: spacing.lg },
  body: { color: lightColors.textSecondary, fontSize: fontSizes.bodyLg, lineHeight: 26, marginBottom: spacing.lg },
  helper: { color: lightColors.textMuted, marginBottom: spacing.xl },
  btn: { backgroundColor: lightColors.accentDefault, height: 52, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
