      ...
      <header className="border-b border-border bg-bg-elevated/80 backdrop-blur sticky top-0 z-10">
        <div className="max-w-6xl mx-auto h-16 flex items-center justify-between px-6">
          ...
          <nav className="hidden md:flex items-center gap-7 text-[14px]">
            ...
            <Link href="#legal" className="text-fg-secondary hover:text-fg">
              Disclosures
            </Link>
            <Link href="#support" className="text-fg-secondary hover:text-fg">
              Support
            </Link>
          </nav>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6 pt-20 pb-24">
          <StatusPill tone="accent" icon={<SparkIcon size={12} />}>
            Embedded finance for life's big purchases
          </StatusPill>
          ...
          <p className="mt-5 text-[18px] text-fg-secondary max-w-2xl leading-relaxed">
            ...
            partners — so you compare real, side-by-side terms, then accept the one that's best for
            you.
          </p>
          ...
          <div className="mt-10 flex flex-wrap items-center gap-x-8 gap-y-3 text-[13px] text-fg-muted">
            <span className="flex items-center gap-1.5">
              <CheckIcon size={14} className="text-success" /> Soft pull only · no score impact
            </span>
            <span className="flex items-center gap-1.5">
              <CheckIcon size={14} className="text-success" /> Bank-backed loans · TILA-disclosed
            </span>
            <span className="flex items-center gap-1.5">
              <CheckIcon size={14} className="text-success" /> Funds same-day via RTP
            </span>
            <span className="flex items-center gap-1.5">
              <CheckIcon size={14} className="text-success" /> AAA-encrypted PII vault
            </span>
          </div>
        </div>
      </section>
      ...
      <section id="how" className="border-t border-border bg-bg-elevated">
        <div className="max-w-6xl mx-auto px-6 py-20">
          ...
          <p className="mt-2 text-[16px] text-fg-muted max-w-2xl">
            Built for the purchases people actually finance — and a fair compare-and-choose
            experience that lets the consumer drive.
          </p>
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              {
                label: 'Home improvement',
                desc: 'Solar, roof, HVAC, kitchen, bathroom.',
                amount: '$2k–$100k',
                term: '24–144 mo',
              },
              {
                label: 'Medical & dental',
                desc: 'Orthodontics, cosmetic, fertility, vision.',
                amount: '$1k–$50k',
                term: '12–84 mo',
              },
              {
                label: 'Auto',
                desc: 'New, used, and private-party purchases.',
                amount: '$5k–$120k',
                term: '24–84 mo',
              },
              {
                label: 'Consolidation',
                desc: 'Replace high-rate credit card debt.',
                amount: '$1k–$40k',
                term: '12–60 mo',
              },
              {
                label: 'Personal',
                desc: 'Weddings, moving, emergencies.',
                amount: '$1k–$25k',
                term: '12–48 mo',
              },
              {
                label: 'Retail',
                desc: 'High-ticket items at participating merchants.',
                amount: '$200–$15k',
                term: '3–48 mo',
              },
            ].map((c) => (
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                title: 'Verify safely',
                desc: 'Confirm your identity (Persona) and income (Plaid). No score impact.',
              },
              {
              ...
              },
              {
                ...
                desc: 'Manage payments, payoff quotes, and hardship help in-app.',
              },
            ].map((step, i) => (
        ...
        <div className="max-w-6xl mx-auto px-6 py-20">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              [
                'Bank-partner backed',
                'Loans are made by chartered partner banks under federal usury preemption.',
              ],
              [
                'Encrypted PII vault',
                'AES-256 with KMS envelope encryption; deterministic SIV for searchable PII.',
              ],
              [
                'Adverse Action defensible',
                'Every decision is reproducible to inputs + policy version, with reason codes.',
              ],
            ].map(([t, d]) => (
      ...
      <footer className="border-t border-border bg-bg-elevated">
        <div className="max-w-6xl mx-auto px-6 py-10 text-[12px] text-fg-muted">
          ...
          <p className="mt-6 leading-relaxed max-w-4xl">
            EazePay, Inc. is a technology platform. Loans surfaced through EazePay are made by
            partner banks or licensed lenders, and may not be available in all states. APRs vary by
            creditworthiness and product. Soft inquiries do not affect your credit score; hard
            inquiries occur only upon offer acceptance and are disclosed in your TILA box. © 2026
            EazePay, Inc.
          </p>
        </div>
      </footer>
