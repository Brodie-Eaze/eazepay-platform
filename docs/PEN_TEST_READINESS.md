...
> - **FIXED** means a finding from [`audits/SECURITY_AUDIT_2026-05-15.md`](audits/SECURITY_AUDIT_2026-05-15.md) has
>   been closed out.
...
These items appear in [`audits/SECURITY_AUDIT_2026-05-15.md`](audits/SECURITY_AUDIT_2026-05-15.md) and the SOC 2 evidence map.
...
[`audits/SECURITY_AUDIT_2026-05-15.md`](audits/SECURITY_AUDIT_2026-05-15.md) where the issue area already has a known ID, or as
